...
public:
	...
	bool DrawString(const std::wstring& text, Gdiplus::Font* font, COLORREF color, Gdiplus::RectF target, Matrix* transform);
...
public:
	...
	void DrawString(const std::wstring& text, float fontSize, Color color, Matrix* pMatrix);
...
public:
	...
	void drawText(const std::wstring& text, float fontSize, Color color);
